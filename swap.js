const { LCDClient, MnemonicKey, MsgSend, isTxError, Coin, MsgSwap } = require('@terra-money/terra.js')
...
const main = async () => {
    ...
    const msg = new MsgSwap(wallet.key.accAddress, toAddress, new Coin("uluna", "1000000"), "uusd");
